...
|----------|-------------|
| [SYSTEM_ARCHITECTURE.md](SYSTEM_ARCHITECTURE.md) | Implemented system design, pipeline, and folder layout |
...
| [DEVELOPMENT_GUIDE.md](DEVELOPMENT_GUIDE.md) | Local setup, Docker, testing, troubleshooting |
